...
const indSeparatedInfo = [
  ...
  {indicator: "ind2_opcat", label: "Ratified UN Optional Protocol", country_text: " countries", color: "#3f84e6", text_color: "black", partial: false},
  {indicator: "ind3_report", label: "Submitted report to CAT", country_text: " countries", color: "#8cb5f0", text_color: "black", partial: false},
  {indicator: "ind4_constitution", label: "Prohibit torture in the constitution", country_text: " countries", color: "#cfa91f", text_color: "black", partial: false},
  ...
  {indicator: "ind5_law_level_1", label: "", country_text: " countries (partially)", color: "#f2d672", text_color: "white", partial: true},
  {indicator: "ind6_npm_level_2", label: "Have a National Preventive Mechanism", country_text: " countries (designated and operational)", color: "#e36360", text_color: "black", partial: false},
  {indicator: "ind6_npm_level_1", label: "", country_text: " countries (designated only)", color: "#e36360", text_color: "black", partial: true},
